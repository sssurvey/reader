# Reader
The reader application is a client application for the website <https://theoldreader.com/feeds>. Currently the app version is ```v0.2.5``` and you can see all you subscription list, and read articles with it.
